...
<div class="grid-container1">
    <div>
        ...
        <?php
            include("display.php");
        ?>
        <a href="cart.php"><img src="src/img/126083.png" height="42" width="42"> </a>
    </div>
<div class="grid-container2">
    <div class="color">
        <a href="http://localhost:8080/rush00/menu.php">
